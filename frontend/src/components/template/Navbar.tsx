                ...
                <div className="container-fluid">
                    ...
                    <div className="dropdown">
                        <a  href="#"
                            ...
                            aria-expanded="false">
                            <img src={img} alt="mdo" width="30" height="30" className="rounded-circle" />
                        </a>
                        <ul className="dropdown-menu text-small shadow dropdown-menu-end" aria-labelledby="dropdownNavbar">
                                <li><a className="dropdown-item"><b>Hi, {name}</b></a></li>
